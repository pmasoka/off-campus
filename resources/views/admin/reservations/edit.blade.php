                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="date" id="res_date" name="res_date"
                                    value="{{ old('res_date', $reservation->res_date->format('Y-m-d')) }}"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                            @error('res_date')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            ...
                            <div class="mt-1">
                                <select id="house_id" name="house_id" class="form-multiselect block w-full mt-1">
                                    @foreach ($houses as $house)
                                        <option value="{{ $house->id }}" @selected(old('house_id', $reservation->house_id))>
                                            {{ $house->address }}
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="student_number" name="student_number"
                                    value="{{ old('student_number', $reservation->student_number) }}"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
