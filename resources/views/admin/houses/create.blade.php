                        ...
                        <div class="mt-6 p-2 bg-slate-100">
                            ...
                            <div class="sm:col-span-6 pt-4">
                                ...
                                <div class="mt-1">
                                    <input type="number" min="0.00" max="10000.00" id="rental_rate"
                                        name="rental_rate" value="{{ old('renatal_rate') }}"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('rental_rate')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
                            ...
                            <div class="sm:col-span-6 pt-4">
                                <label for="no_of_washrooms" class="block text-sm font-medium text-gray-700"> Number
                                    of Washrooms </label>
                                <div class="mt-1">
                                    <input type="number" value="{{ old('no_of_washrooms') }}" id="no_of_washrooms"
                            ...
                            <div class="sm:col-span-6 pt-4">
                                <label for="student_number" class="block text-sm font-medium text-gray-700"> Number of
                                    Students </label>
                                <div class="mt-1">
                                    <input type="number" value="{{ old('student_number') }}" id="student_number"
                                        name="student_number"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                        ...
                        <div class="mt-6 p-2 bg-slate-100">
                            ...
                            <div class="sm:col-span-6 pt-4">
                                <label for="distance" class="block text-sm font-medium text-gray-700"> Distance to
                                    Campus </label>
                                <div class="mt-1">
                                    <input type="number" value="{{ old('distance') }}" id="distance"
                                        name="distance"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('distance')
                            ...
                            <div class="sm:col-span-6 pt-4">
                                ...
                                <div class="mt-1">
                                    <input type="number" value="{{ old('w_time') }}" id="w_time" name="w_time"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('w_time')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
                            ...
                            <div class="sm:col-span-6 pt-4">
                                ...
                                <div class="mt-1">
                                    <input type="number" value="{{ old('c_time') }}" id="c_time" name="c_time"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('c_time')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
                            ...
                            <div class="sm:col-span-6 pt-4">
                                ...
                                <div class="mt-1">
                                    <input type="number" value="{{ old('d_time') }}" id="d_time" name="d_time"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('d_time')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
